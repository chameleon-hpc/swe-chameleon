...
echo $MPIEXEC $FLAGS_MPI_BATCH ./build/SWE_intel_release_mpi_omp_hybrid -t 1 -n 1 -x 1024 -y 1024 -o ./output/mpi_batch

### Execute your application
$MPIEXEC $FLAGS_MPI_BATCH ./build/SWE_intel_release_mpi_omp_hybrid -t 1 -n 1 -x 1024 -y 1024 -o ./output/mpi_batch
